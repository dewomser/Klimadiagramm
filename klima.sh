...
wetterdienst values --provider=DWD --network=Observation --parameters=annual,climate_summary,precipitation_height --name=Worms --format=csv>regen_klima.csv

wetterdienst values --provider=DWD --network=Observation --parameters=annual,climate_summary,temperature_air_mean_2m --name=Worms --format=csv>temp_klima.csv
